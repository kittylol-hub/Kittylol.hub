...
local Library = { 
    ...
    local Themes = {
        ["Preset"] = {
            ...
            ["Accent 2"] = Color3.fromRGB(220, 70, 145),
            ["Accent 3"] = Color3.fromRGB(245, 90, 165),
            ["Accent 4"] = Color3.fromRGB(255, 130, 195),
        }
    }
    ...
    -- Pink keyboard UI toggle/picker
    do
        local KeyPicker = Library:Create("ScreenGui", {
            Parent = gethui(),
            Name = "KeyboardKeyPicker",
            IgnoreGuiInset = true,
            ZIndexBehavior = Enum.ZIndexBehavior.Global,
            ResetOnSpawn = false
        })
        ...
        Mini.Name = "Keyboard"
        Mini.Size = UDim2.fromOffset(38, 30)
        Mini.Position = UDim2.new(1, -48, 0, 12)
        Mini.BackgroundColor3 = Color3.fromRGB(10, 10, 12)
        Mini.TextColor3 = Color3.fromRGB(255, 105, 180)
        Mini.Text = "⌨"
        Mini.TextSize = 18
        Mini.Font = Enum.Font.GothamBold
        Mini.AutoButtonColor = false
        Mini.Parent = KeyPicker.Instance
        ...
        Panel.Position = UDim2.new(1, -310, 0, 48)
        Panel.BackgroundColor3 = Color3.fromRGB(8, 8, 10)
        Panel.Visible = false
        Panel.Parent = KeyPicker.Instance
        ...
        Current.Size = UDim2.new(1, -20, 0, 24)
        Current.Position = UDim2.fromOffset(10, 36)
        Current.BackgroundTransparency = 1
        Current.Text = "Toggle key: K"
        Current.TextColor3 = Color3.fromRGB(255, 180, 220)
        Current.Font = Enum.Font.Gotham
        Current.TextSize = 13
        Current.Parent = Panel

        local Grid = Instance.new("Frame")
        Grid.Size = UDim2.new(1, -20, 1, -72)
        Grid.Position = UDim2.fromOffset(10, 66)
        Grid.BackgroundTransparency = 1
        Grid.Parent = Panel
        local layout = Instance.new("UIGridLayout", Grid)
        layout.CellSize = UDim2.fromOffset(31, 31)
        ...
        local function SetMenuKey(name)
            Library.MenuKeybind = tostring(Enum.KeyCode[name])
            Current.Text = "Toggle key: "..name
        end
        ...
        for _, name in ipairs(keys) do
            ...
            b.TextColor3 = Color3.fromRGB(255,105,180)
            b.Text = name
            ...
            st.Color = Color3.fromRGB(55,25,42)
        ...
        Library.CreateColorpicker = function(Self, Data)
            ...
            function Colorpicker:SetOpen(Bool)
                ...
                if Colorpicker.IsOpen then 
                    Data.Items["Text"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
                    Data.Items["Value"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
...
-- Light-sweep shimmer effect across the UI name (like SKR UI's ClientName gradient)
Items["TitleGradient"] = Library:Create("UIGradient", {
    Name = "\0",
    Parent = Items["Title"].Instance,
    Color = ColorSequence.new({
        ColorSequenceKeypoint.new(0, Color3.fromRGB(120, 20, 20)),
        ColorSequenceKeypoint.new(0.5, Color3.fromRGB(255, 210, 210)),
        ColorSequenceKeypoint.new(1, Color3.fromRGB(120, 20, 20))
    })
})

Library:Thread(function()
    while Items["Title"].Instance and Items["Title"].Instance.Parent do
        Items["TitleGradient"].Instance.Offset = Vector2.new(math.sin(os.clock() * 1.5), 0)
        task.wait()
    end
end)
    ...
    Window:SetOpen(not Window.IsOpen)
        ...
        Library.SubPage = function(Self, Params)
            ...
            function Page:Turn(Bool)
                ...
                if Bool then 
                    ...
                    Items["Text"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
                end
        ...
        Library.Slider = function(Self, Params)
            ...
            Items["RealSlider"]:Connect("InputBegan", function(Input)
                if Input.UserInputType == Enum.UserInputType.MouseButton1 or Input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    Items["Text"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
                    Items["Value"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
            ...
            function Dropdown:Add(Value)
                ...
                function OptionData:ToggleState(Value)
                    if Value == "Active" then
                        ...
                        OptionText:Tween({Position = UDim2.new(0, 0, 0.5, 0), TextColor3 = Color3.fromRGB(255, 105, 180)})
        ...
        Library.Textbox = function(Self, Params)
            ...
            Items["Input"]:Connect("FocusLost", function(PressedEnterQuestionMark)
                ...
                Items["Text"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
                Items["Input"]:Tween({TextColor3 = Color3.fromRGB(255, 105, 180)})
            end)
        ...
        Library.CreateSettingsPage = function(Self)
            ...
            do
                ...
                ConfigsSection:Label({Name = "UI Bind"}):Keybind({Flag = "UIBind", Mode = "Toggle", Default = Enum.KeyCode.K, Callback = function(Value)
